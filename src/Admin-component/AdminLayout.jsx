...
import { BarChart3, Users, ShieldAlert, Menu, X, LogOut, Bell } from "lucide-react";
      ...
      <aside className="hidden lg:flex w-72 flex-col bg-slate-900 text-white sticky top-0 h-screen transition-all duration-300">
        <div className="p-8">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h1 className="text-xl font-black tracking-tight">BloodFinder <span className="text-rose-500">.</span></h1>
          </div>
